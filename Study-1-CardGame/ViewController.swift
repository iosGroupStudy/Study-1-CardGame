...
//    let fourthCardButton = UIButton()
    ...
    let cardButtons = [UIButton(), UIButton(), UIButton(), UIButton()]
...
//        cardButton.addTarget(self, action: #selector(self.flipCard(sender:)), for: .touchUpInside)
...
//        thirdCardButton.backgroundColor = .white
//        thirdCardButton.setTitle("🐡", for: .normal)
//        thirdCardButton.titleLabel?.font = UIFont.boldSystemFont(ofSize: 50)
//        thirdCardButton.frame = CGRect(x: 300, y: 100, width: 80, height: 120)
//        thirdCardButton.addTarget(self, action: #selector(self.flipSecondCard), for: .touchUpInside)
//
//        view.addSubview(fourthCardButton)
//        fourthCardButton.backgroundColor = .white
//        fourthCardButton.setTitle("🐡", for: .normal)
//        fourthCardButton.titleLabel?.font = UIFont.boldSystemFont(ofSize: 50)
//        fourthCardButton.frame = CGRect(x: 300, y: 100, width: 80, height: 120)
//        fourthCardButton.addTarget(self, action: #selector(self.flipSecondCard), for: .touchUpInside)
...
//            button.setTitle("🐡", for: .normal)
            ...
            button.frame = CGRect(x: 100, y: 100 + index * 150, width: 80, height: 120)
        ...
        flipCountLabel.frame = CGRect(x: 30, y: 200, width: 300, height: 1000)
        // Int 값을 String으로 변환
